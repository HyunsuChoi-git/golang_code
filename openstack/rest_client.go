...
func callExecute(req *http.Request, mappingData interface{}) (http.Header, int, error) {
	...
	respHeader, respBody, statusCode, err := h.ExecuteService(req)
